...
public class LanesIntersectionRight {
	public static void main(String[] args) {
       ...
       // p19.Value.Size = 3;
        ...
        p20.Value = new TransferOperation("localhost", "1080", "P_a3");
        ...
        Condition T10Ct1 = new Condition(t10, "P_o2",TransitionCondition.NotNull);
