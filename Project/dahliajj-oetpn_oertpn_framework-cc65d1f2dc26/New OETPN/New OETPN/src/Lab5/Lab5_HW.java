...
public class Lab5_HW {
	...
	public static PetriNet PN3() {
		...
		p35.SetName("p35");
		p35.Value = new TransferOperation("10.132.80.82", "1080", "p6");
	...
	public static PetriNet PN4() {
		...
		p44.SetName("p44");
		p44.Value = new TransferOperation("10.132.80.82", "1080", "p6");
		...
		Condition t44Ct2 = new Condition(t44, "p43", TransitionCondition.MoreThanOrEqual, "constantVal5");
		...
		Condition t43Ct2 = new Condition(t43, "p43", TransitionCondition.LessThan, "constantVal5");
...
//Done Added
	public static void main(String[] args) {
		...
		p3Send.Value = new TransferOperation("10.132.85.230", "1090", "p22");
