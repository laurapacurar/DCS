...
public class Lanes_Intersection {
	public static void main(String[] args) {
		...
		GuardMapping grd1T1 = new GuardMapping();
		grd1T1.condition = T1Ct1;
		grd1T1.Activations.add(new Activation(t1, "P_a1", TransitionOperation.AddElement, "P_x1"));
		t1.GuardMappingList.add(grd1T1);

		GuardMapping grd2T1 = new GuardMapping();
		grd2T1.condition = T1Ct3;
		grd2T1.Activations.add(new Activation(t1, "full", TransitionOperation.SendOverNetwork, "OP1"));
...
//		t2.Delay = 3;
		...
		GuardMapping grd1T3 = new GuardMapping();
		grd1T3.condition = T3Ct1;
		grd1T3.Activations.add(new Activation(t3, "P_a2", TransitionOperation.AddElement, "P_x2"));
		t3.GuardMappingList.add(grd1T3);

		GuardMapping grd2T3 = new GuardMapping();
		grd2T3.condition = T3Ct3;
		grd2T3.Activations.add(new Activation(t3, "full", TransitionOperation.SendOverNetwork, "OP2"));
		grd2T3.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Move, "P_a2"));
		...
		GuardMapping grd1T5 = new GuardMapping();
		grd1T5.condition = T5Ct1;
		grd1T5.Activations.add(new Activation(t5, "P_a3", TransitionOperation.AddElement, "P_x3"));
		t5.GuardMappingList.add(grd1T5);

		GuardMapping grd2T5 = new GuardMapping();
		grd2T5.condition = T5Ct3;
		grd2T5.Activations.add(new Activation(t5, "full", TransitionOperation.SendOverNetwork, "OP3"));
		grd2T5.Activations.add(new Activation(t5, "P_a3", TransitionOperation.Move, "P_a3"));
		t5.GuardMappingList.add(grd2T5);
		...
		GuardMapping grd1T7 = new GuardMapping();
		grd1T7.condition = T7Ct1;
		grd1T7.Activations.add(new Activation(t7, "P_a4", TransitionOperation.AddElement, "P_x4"));
		t7.GuardMappingList.add(grd1T7);

		GuardMapping grd2T7 = new GuardMapping();
		grd2T7.condition = T7Ct3;
		grd2T7.Activations.add(new Activation(t7, "full", TransitionOperation.SendOverNetwork, "OP4"));
		grd2T7.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Move, "P_a4"));
		t7.GuardMappingList.add(grd2T7);
