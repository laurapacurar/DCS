...
public class Terminal2_OETPN {
    private static DataString p_display;

    public static void main(String[] args) {
        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Terminal 2 Petri";
        pn.NetworkPort = 1081;
        ...
        p_inp_term2.SetName("P_input_term1");
        ...
        p_output.Value = new TransferOperation("localhost", "1080", "P_input_term2");
        ...
        t3.InputPlaceName.add("P_input_term1");
        t3.InputPlaceName.add("P_aux");

        Condition T3Ct1 = new Condition(t3, "P_input_term1", TransitionCondition.NotNull);

        GuardMapping grdT3 = new GuardMapping();
        grdT3.condition = T3Ct1;
        grdT3.Activations.add(new Activation(t3, "P_input_term1", TransitionOperation.Move, "P_display"));

        t3.GuardMappingList.add(grdT3);

        Condition T3Ct2 = new Condition(t3, "P_input_term1", TransitionCondition.Equal);
